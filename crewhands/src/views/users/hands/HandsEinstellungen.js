    ...
    <div>
      <Section>
        ...
        <SubSection>
          ...
          <legend>//this.state.userName</legend> <Button> Ändern</Button>
        </SubSection>
        <SubSection>
          <legend>Password:</legend>
          <legend>//this.state.password</legend> <Button> Ändern</Button>
        </SubSection>
        <SubSection>
          <legend>E-Mail:</legend>
          <legend>//this.state.email</legend> <Button> Ändern</Button>
        </SubSection>
        <div>
